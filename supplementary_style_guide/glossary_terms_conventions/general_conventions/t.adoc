...
*Description*: In Red Hat Enterprise Linux, a _Trigger directive_ is a special form of a transaction scriptlet that is conditionally executed when another specific package is installed or uninstalled.
