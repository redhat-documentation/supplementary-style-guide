...
In addition to the _IBM Style Guide_ and the Red Hat supplementary style guide for product documentation, Red Hat product documentation uses the following reference guides for non-writing style topics:
