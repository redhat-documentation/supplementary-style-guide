...
* *xref:links[Links to Red Hat documentation]*: Added guidance to use `latest` in links to Red Hat documentation to simplify maintenance. Added guidance for projects that must link to specific versions.
