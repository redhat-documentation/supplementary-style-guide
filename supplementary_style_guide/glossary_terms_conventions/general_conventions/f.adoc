...
*Description*: In Red Hat Enterprise Linux, a _File Trigger_ is a special form of a transaction scriptlet that is conditionally executed when matching files from other packages are installed or uninstalled.
