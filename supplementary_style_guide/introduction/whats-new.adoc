...
With this update, the SSG is automatically generated in Markdown format in addition to being available as a PDF and in HTML. This change optimizes the SSG for AI consumption and machine reading.
