...
*Description*: In Red Hat Decision Manager and Red Hat Process Automation Manager, an _organizational unit_ is a directory comprising repositories that store business assets.
