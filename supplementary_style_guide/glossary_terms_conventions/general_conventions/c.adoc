...
*Description*: Use _currently_ to refer to a situation that will change in the future. For example, you can use _currently_ in release notes when a known issue will likely be fixed in an upcoming release. 
