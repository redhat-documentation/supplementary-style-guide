...
* Never use "supported as a Technology Preview", avoid "support" in Technology Preeview descriptions if possible. Instead, use neutral words like "available", "provide", "capability", "functionality", "implement", "enable", and so on.
