...
==== image:images/no.png[no] natively compiled code (noun)
*Description*: _Natively compiled code_ is code written in a programming language that compiles to machine code with a resulting binary executable file. Such code can be run stand-alone.
