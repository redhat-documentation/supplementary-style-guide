...
.Glossary entries
* agnostic: Removed glossary entry in favor of following the IBM Style guidance
* client side: Removed glossary entry in favor of following the IBM Style guidance
* client-side: Removed glossary entry in favor of following the IBM Style guidance
* cloud: Removed glossary entry in favor of following the IBM Style guidance
* colocate: Removed glossary entry in favor of following the IBM Style guidance
* data center: Removed glossary entry in favor of following the IBM Style guidance
* devops: Removed glossary entry in favor of following the IBM Style guidance
