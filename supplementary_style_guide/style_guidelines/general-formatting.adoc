...
.Example (before)
You can exclude overcloud nodes from receiving an updated deployment. This means that the blacklisted nodes are isolated from the effects of the stack operation. 
