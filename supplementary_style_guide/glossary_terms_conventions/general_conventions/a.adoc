...
*Description*: RHEL content in the _AppStream repository_ includes Application Streams, such as additional user-space applications, runtime languages, and databases in support of varied workloads and use cases.
