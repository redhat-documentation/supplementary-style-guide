...
*See also*: xref:physical-disk[physical disk]
...
*Description*: In Red{nbsp}Hat Gluster Storage, a _volume file_ is a configuration file that determines the behavior of the trusted storage pool.
