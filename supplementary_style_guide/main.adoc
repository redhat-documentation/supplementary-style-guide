...
These recommendations might override existing guidance in the _IBM Style Guide_, or might provide guidance for items not covered in the _IBM Style Guide_.
