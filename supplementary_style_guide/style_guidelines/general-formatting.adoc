...
NOTE:: Additional information that provides guidance or advice that improves product configuration, performance, or supportability.
...
TIP:: Makes applying the techniques and procedures described in the text easier or targets specific needs. Alternative methods that might not be obvious. Helps users understand the benefits and capabilities of the product. Not essential to using the product.
