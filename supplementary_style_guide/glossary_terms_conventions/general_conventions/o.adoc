...
[discrete]
[[openshift-master]]
==== image:images/no.png[no] OpenShift master (noun)
*Description*: In Red Hat OpenShift, do not use the term "OpenShift master". Use "control plane" instead.

*Use it*: no

*Incorrect forms*:

*See also*: xref:control-plane[control plane]
