...
Do not use bold formatting as a default for the output. Nevertheless, if you require highlighting a specific part of the output, bold formatting can be used. However, to avoid clashing with the command visually, consider other methods of highlighting, such as italics or callouts.
