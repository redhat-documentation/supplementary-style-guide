...
*Description*: In Red Hat Process Automation Manager, _knowledge store_ is a centralized repository for business knowledge. The knowledge store connects to a Git repository to store various knowledge assets and artifacts at a single location.
