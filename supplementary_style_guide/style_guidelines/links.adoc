...
* Minimize links to external sites not owned and operated by Red{nbsp}Hat or IBM. Links to external sites can change or be unreliable. Customers might infer that Red{nbsp}Hat endorses or supports the linked content, even if that is not the intent.
