...
* Animate user
+
image:images/no.png[yes] A _user who_ creates a file is the owner of that file.
+
...
+
image:images/yes.png[yes] A Linux user has the restrictions of the _SELinux user_ to _which_ it is assigned.
+
