...
image:images/Structure-of-an-AsciiDoc-procedure.png[Place additional information before prerequisites,width=50%,align="center"]
...
image:images/Structure-of-a-DITA-procedure.png[Place additional information after prerequisites,width=50%,align="center"]
...
[subs="+quotes"]
----
*Original:* This chapter describes creating, registering, administering, and removing hosts.
----

[subs="+quotes"]
----
*Rewrite:* Administering hosts lets you maintain your Linux systems [*what*], ensuring they are secure and up-to-date [*why*].
----
...
.Comparison between warm and cold migration
