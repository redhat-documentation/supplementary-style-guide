...
* Write _service_ in lowercase if the component name includes _service_.
* Write the code name in lowercase in parentheses after the component name, and after _service_, on the first use of the component name in a module.
