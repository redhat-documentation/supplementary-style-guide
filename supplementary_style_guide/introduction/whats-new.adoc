...
* *xref:explain-commands-variables-in-code-blocks[Explanation of commands and variables used in code blocks]*. Customer Content Services is no longer using callouts in documentation. Callouts are not supported by DITA and do not work for AI. 
