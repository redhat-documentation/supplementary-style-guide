...
* xref:certificate-authority[certificate authority]: Updated to remove extraneous IdM definitions
...
.Other updates
* Added xref:non-breaking-spaces[non-breaking spaces] between "Red" and "Hat" within the guide.
* xref:shortdesc[Short descriptions]: Added guidance on writing short descriptions and abstracts.
