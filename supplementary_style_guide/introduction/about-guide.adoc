...
The _Red{nbsp}Hat supplementary style guide for product documentation_ is also available as a Markdown file. You can download or reference the link:ssg.md[Markdown version of the guide] for use with tools and workflows that consume Markdown.
