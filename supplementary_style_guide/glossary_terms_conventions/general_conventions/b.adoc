...
*Description*: A _bytecode_ is a non-human-readable instruction set generated by a compiler. Bytecode is typically either executed by a virtual machine (VM) or compiled again into machine code.
