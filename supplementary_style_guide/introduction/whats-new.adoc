...
.Style guidance
* *xref:commands-with-root-privileges[Commands requiring root privileges]*: Added guidance to include an example
* *xref:release-notes[Release notes]*: Added guidance on referring to release versions for documentation on deprecated and removed features
