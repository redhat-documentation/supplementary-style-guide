...
*Description*: In Red{nbsp}Hat OpenShift, _egress_ describes the process of network traffic leaving a Red{nbsp}Hat OpenShift cluster. Alternatively, data _ingress_ refers to outside network traffic entering an OpenShift cluster.

*Use it*: yes

*Incorrect forms*:

*See also*: xref:ingress[ingress]
