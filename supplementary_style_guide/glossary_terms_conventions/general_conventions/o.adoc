...
*Description*: In Red Hat Decision Manager and Red Hat Process Automatio M, an _organizational unit_ is a directory comprising repositories that store business assets.
