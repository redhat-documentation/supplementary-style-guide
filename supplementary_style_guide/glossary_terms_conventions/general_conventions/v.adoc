...
*Description*: A temporary storage, for example random access memory (RAM), that requires power to maintain the stored information. The stored data is lost when the device is turned off or restarts.
