...
*Description*: In Red Hat Enterprise Linux, the content in the _BaseOS repository_ provides the core set of the underlying OS functionality that provides the foundation for all installations.
